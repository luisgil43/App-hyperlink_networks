...
urlpatterns = [
    ...
    path("cartola/editar-tipo/<int:pk>/", views.editar_tipo, name="editar_tipo"),
    path("cartola/eliminar-tipo/<int:pk>/", views.eliminar_tipo, name="eliminar_tipo"),
    path("cartola/toggle-tipo/<int:pk>/", views.toggle_tipo, name="toggle_tipo"),
    ...
    path(
        "proyectos/eliminar/<int:pk>/",
        views.eliminar_proyecto,
        name="eliminar_proyecto",
    ),
    path(
        "cartola/aprobar/<int:pk>/", views.aprobar_movimiento, name="aprobar_movimiento"
    ),
    path(
        "cartola/rechazar/<int:pk>/",
        views.rechazar_movimiento,
        name="rechazar_movimiento",
    ),
    path("cartola/editar/<int:pk>/", views.editar_movimiento, name="editar_movimiento"),
    path(
        "cartola/eliminar/<int:pk>/",
        views.eliminar_movimiento,
        name="eliminar_movimiento",
    ),
    path(
        "saldos-usuarios/", views.listar_saldos_usuarios, name="listar_saldos_usuarios"
    ),
    ...
    path(
        ...
        views.invoice_discount_verified,
        name="invoice_discount_verified",
    ),
    path(
        "cartola/aprobar-abono-como-usuario/<int:pk>/",
        views.aprobar_abono_como_usuario,
        name="aprobar_abono_como_usuario",
    ),
    path(
        "invoices/<int:session_id>/duplicate/preview/",
        views_split.duplicate_preview,
        name="invoices_duplicate_preview",
    ),
    path(
        "invoices/<int:session_id>/duplicate/commit/",
        views_split.duplicate_commit,
        name="invoices_duplicate_commit",
    ),
    path(
        "invoices/<int:session_id>/split-delete/",
