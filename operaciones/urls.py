...
urlpatterns = [
    ...
    # path('supervisor/listar/', views.listar_servicios_supervisor, name='listar_servicios_supervisor'),
    # path('cotizaciones/<int:pk>/asignar/', views.asignar_trabajadores, name='asignar_cotizacion'),
    # path('mis-servicios/', views.mis_servicios_tecnico, name='mis_servicios_tecnico'),
    # path('aceptar-servicio/<int:servicio_id>/', views.aceptar_servicio, name='aceptar_servicio'),
    # path('finalizar-servicio/<int:servicio_id>/', views.finalizar_servicio, name='finalizar_servicio'),
    # path('servicios/<int:pk>/rechazar-asignacion/', views.rechazar_asignacion, name='rechazar_asignacion'),
    # path('servicios/<int:pk>/aprobar-asignacion/', views.aprobar_asignacion, name='aprobar_asignacion'),
    # path('servicios/supervisor/exportar/', views.exportar_servicios_supervisor, name='exportar_servicios_supervisor'),
